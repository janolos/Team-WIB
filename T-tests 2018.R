...
b2018 = B2018[keeps]
names(b2018)[names(b2018)=="SEX"] = "Owners_Sex"
names(b2018)[names(b2018)=="NAICS2017"] = "NAICS Code"
names(b2018)[names(b2018)=="ETH_GROUP"] = "Ethnicity"
names(b2018)[names(b2018)=="RACE_GROUP"] = "Race"
names(b2018)[names(b2018)=="RCPPDEMP"] = "Sales"


#Convert sales to numeric values

str(b2018$Sales)
b2018$Sales2 = as.numeric(b2018$Sales)
b2018_1 = na.omit(b2018)
View(b2018_1) 
...
ES = ggplot(b2018, aes(x=Ethnicity, y=Sales2))
ES + geom_point() #no linear relationship
ES + geom_boxplot() + scale_y_log10()
ggplot(b2018_1, aes(Ethnicity))+geom_bar()
...
SS = ggplot(b2018, aes(x=Owners_Sex, y = Sales2))
SS + geom_point() #There is no linear relationship between Sales and Owners_Sex.
SS + geom_boxplot() + scale_y_log10()
ggplot(b2018_1, aes(Owners_Sex))+geom_bar() #There were more male-owned businesses in 2019.Followed by equally male/female owned businesses.